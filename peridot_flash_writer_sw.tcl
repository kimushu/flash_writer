...
add_sw_setting quoted_string system_h_define on_chip_flash.name PERIDOT_FLASH_WRITER_OCF_NAME "/dev/altera_onchip_flash_data" "Device name of altera_onchip_flash CSR"
